...
public class CkZipEntry {
  ...
  public int get_EncryptionKeyLen() {
    return chilkatJNI.CkZipEntry_get_EncryptionKeyLen(swigCPtr, this);
  }
  ...
  public boolean get_IsAesEncrypted() {
    return chilkatJNI.CkZipEntry_get_IsAesEncrypted(swigCPtr, this);
  }
  ...
  public boolean AppendString(String strContent, String charset) {
    return chilkatJNI.CkZipEntry_AppendString(swigCPtr, this, strContent, charset);
  }

  public CkTask AppendStringAsync(String strContent, String charset) {
    long cPtr = chilkatJNI.CkZipEntry_AppendStringAsync(swigCPtr, this, strContent, charset);
    return (cPtr == 0) ? null : new CkTask(cPtr, true);
  }
  ...
  public boolean ReplaceString(String strContent, String charset) {
    return chilkatJNI.CkZipEntry_ReplaceString(swigCPtr, this, strContent, charset);
  }
  ...
  public boolean UnzipToBd(CkBinData binData) {
    return chilkatJNI.CkZipEntry_UnzipToBd(swigCPtr, this, CkBinData.getCPtr(binData), binData);
  }

  public CkTask UnzipToBdAsync(CkBinData binData) {
    long cPtr = chilkatJNI.CkZipEntry_UnzipToBdAsync(swigCPtr, this, CkBinData.getCPtr(binData), binData);
    return (cPtr == 0) ? null : new CkTask(cPtr, true);
  }

  public boolean UnzipToSb(int lineEndingBehavior, String srcCharset, CkStringBuilder sb) {
    return chilkatJNI.CkZipEntry_UnzipToSb(swigCPtr, this, lineEndingBehavior, srcCharset, CkStringBuilder.getCPtr(sb), sb);
  }

  public CkTask UnzipToSbAsync(int lineEndingBehavior, String srcCharset, CkStringBuilder sb) {
    long cPtr = chilkatJNI.CkZipEntry_UnzipToSbAsync(swigCPtr, this, lineEndingBehavior, srcCharset, CkStringBuilder.getCPtr(sb), sb);
    return (cPtr == 0) ? null : new CkTask(cPtr, true);
  }

  public boolean UnzipToStream(CkStream toStream) {
    return chilkatJNI.CkZipEntry_UnzipToStream(swigCPtr, this, CkStream.getCPtr(toStream), toStream);
  }

  public CkTask UnzipToStreamAsync(CkStream toStream) {
    long cPtr = chilkatJNI.CkZipEntry_UnzipToStreamAsync(swigCPtr, this, CkStream.getCPtr(toStream), toStream);
    return (cPtr == 0) ? null : new CkTask(cPtr, true);
  }
