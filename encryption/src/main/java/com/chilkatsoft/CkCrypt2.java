...
public class CkCrypt2 {
  ...
  public void get_OaepMgfHash(CkString str) {
    chilkatJNI.CkCrypt2_get_OaepMgfHash(swigCPtr, this, CkString.getCPtr(str), str);
  }

  public String oaepMgfHash() {
    return chilkatJNI.CkCrypt2_oaepMgfHash(swigCPtr, this);
  }

  public void put_OaepMgfHash(String newVal) {
    chilkatJNI.CkCrypt2_put_OaepMgfHash(swigCPtr, this, newVal);
  }
  ...
  public void get_SigningAttributes(CkString str) {
    chilkatJNI.CkCrypt2_get_SigningAttributes(swigCPtr, this, CkString.getCPtr(str), str);
  }

  public String signingAttributes() {
    return chilkatJNI.CkCrypt2_signingAttributes(swigCPtr, this);
  }

  public void put_SigningAttributes(String newVal) {
    chilkatJNI.CkCrypt2_put_SigningAttributes(swigCPtr, this, newVal);
  }
  ...
  public boolean DecryptSecureENC(String cipherText, CkSecureString secureStr) {
    return chilkatJNI.CkCrypt2_DecryptSecureENC(swigCPtr, this, cipherText, CkSecureString.getCPtr(secureStr), secureStr);
  }
  ...
  public boolean EncryptSecureENC(CkSecureString secureStr, CkString outStr) {
    return chilkatJNI.CkCrypt2_EncryptSecureENC(swigCPtr, this, CkSecureString.getCPtr(secureStr), secureStr, CkString.getCPtr(outStr), outStr);
  }

  public String encryptSecureENC(CkSecureString secureStr) {
    return chilkatJNI.CkCrypt2_encryptSecureENC(swigCPtr, this, CkSecureString.getCPtr(secureStr), secureStr);
  }
  ...
  public boolean GetSignedAttributes(int signerIndex, CkBinData pkcs7Der, CkStringBuilder sbJson) {
    return chilkatJNI.CkCrypt2_GetSignedAttributes(swigCPtr, this, signerIndex, CkBinData.getCPtr(pkcs7Der), pkcs7Der, CkStringBuilder.getCPtr(sbJson), sbJson);
  }
