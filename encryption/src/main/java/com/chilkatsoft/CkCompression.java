...
public class CkCompression {
  ...
  public int get_DeflateLevel() {
    return chilkatJNI.CkCompression_get_DeflateLevel(swigCPtr, this);
  }

  public void put_DeflateLevel(int newVal) {
    chilkatJNI.CkCompression_put_DeflateLevel(swigCPtr, this, newVal);
  }
  ...
  public boolean CompressBd(CkBinData binData) {
    return chilkatJNI.CkCompression_CompressBd(swigCPtr, this, CkBinData.getCPtr(binData), binData);
  }

  public CkTask CompressBdAsync(CkBinData binData) {
    long cPtr = chilkatJNI.CkCompression_CompressBdAsync(swigCPtr, this, CkBinData.getCPtr(binData), binData);
    return (cPtr == 0) ? null : new CkTask(cPtr, true);
  }
  ...
  public boolean CompressSb(CkStringBuilder sb, CkBinData binData) {
    return chilkatJNI.CkCompression_CompressSb(swigCPtr, this, CkStringBuilder.getCPtr(sb), sb, CkBinData.getCPtr(binData), binData);
  }

  public CkTask CompressSbAsync(CkStringBuilder sb, CkBinData binData) {
    long cPtr = chilkatJNI.CkCompression_CompressSbAsync(swigCPtr, this, CkStringBuilder.getCPtr(sb), sb, CkBinData.getCPtr(binData), binData);
    return (cPtr == 0) ? null : new CkTask(cPtr, true);
  }
  ...
  public boolean DecompressBd(CkBinData binData) {
    return chilkatJNI.CkCompression_DecompressBd(swigCPtr, this, CkBinData.getCPtr(binData), binData);
  }

  public CkTask DecompressBdAsync(CkBinData binData) {
    long cPtr = chilkatJNI.CkCompression_DecompressBdAsync(swigCPtr, this, CkBinData.getCPtr(binData), binData);
    return (cPtr == 0) ? null : new CkTask(cPtr, true);
  }
  ...
  public boolean DecompressSb(CkBinData binData, CkStringBuilder sb) {
    return chilkatJNI.CkCompression_DecompressSb(swigCPtr, this, CkBinData.getCPtr(binData), binData, CkStringBuilder.getCPtr(sb), sb);
  }

  public CkTask DecompressSbAsync(CkBinData binData, CkStringBuilder sb) {
    long cPtr = chilkatJNI.CkCompression_DecompressSbAsync(swigCPtr, this, CkBinData.getCPtr(binData), binData, CkStringBuilder.getCPtr(sb), sb);
    return (cPtr == 0) ? null : new CkTask(cPtr, true);
  }
