...
public class CkJavaKeyStore {
  ...
  public int get_NumSecretKeys() {
    return chilkatJNI.CkJavaKeyStore_get_NumSecretKeys(swigCPtr, this);
  }
  ...
  public boolean AddSecretKey(String encodedKeyBytes, String encoding, String algorithm, String alias, String password) {
    return chilkatJNI.CkJavaKeyStore_AddSecretKey(swigCPtr, this, encodedKeyBytes, encoding, algorithm, alias, password);
  }
  ...
  public boolean GetSecretKey(String password, int index, String encoding, CkString outStr) {
    return chilkatJNI.CkJavaKeyStore_GetSecretKey(swigCPtr, this, password, index, encoding, CkString.getCPtr(outStr), outStr);
  }

  public String getSecretKey(String password, int index, String encoding) {
    return chilkatJNI.CkJavaKeyStore_getSecretKey(swigCPtr, this, password, index, encoding);
  }

  public String secretKey(String password, int index, String encoding) {
    return chilkatJNI.CkJavaKeyStore_secretKey(swigCPtr, this, password, index, encoding);
  }

  public boolean GetSecretKeyAlias(int index, CkString outStr) {
    return chilkatJNI.CkJavaKeyStore_GetSecretKeyAlias(swigCPtr, this, index, CkString.getCPtr(outStr), outStr);
  }

  public String getSecretKeyAlias(int index) {
    return chilkatJNI.CkJavaKeyStore_getSecretKeyAlias(swigCPtr, this, index);
  }

  public String secretKeyAlias(int index) {
    return chilkatJNI.CkJavaKeyStore_secretKeyAlias(swigCPtr, this, index);
  }
  ...
  public boolean LoadJwkSet(String password, CkJsonObject jwkSet) {
    return chilkatJNI.CkJavaKeyStore_LoadJwkSet(swigCPtr, this, password, CkJsonObject.getCPtr(jwkSet), jwkSet);
  }
  ...
  public boolean ToJwkSet(String password, CkStringBuilder sbJwkSet) {
    return chilkatJNI.CkJavaKeyStore_ToJwkSet(swigCPtr, this, password, CkStringBuilder.getCPtr(sbJwkSet), sbJwkSet);
  }
