...
public class CkCert {
  ...
  public void get_SerialDecimal(CkString str) {
    chilkatJNI.CkCert_get_SerialDecimal(swigCPtr, this, CkString.getCPtr(str), str);
  }

  public String serialDecimal() {
    return chilkatJNI.CkCert_serialDecimal(swigCPtr, this);
  }
  ...
  public String smartCardPin() {
    return chilkatJNI.CkCert_smartCardPin(swigCPtr, this);
  }

  public void put_SmartCardPin(String newVal) {
    chilkatJNI.CkCert_put_SmartCardPin(swigCPtr, this, newVal);
  }
  ...
  public boolean HashOf(String part, String hashAlg, String encoding, CkString outStr) {
    return chilkatJNI.CkCert_HashOf(swigCPtr, this, part, hashAlg, encoding, CkString.getCPtr(outStr), outStr);
  }

  public String hashOf(String part, String hashAlg, String encoding) {
    return chilkatJNI.CkCert_hashOf(swigCPtr, this, part, hashAlg, encoding);
  }
